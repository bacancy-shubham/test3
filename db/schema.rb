...
ActiveRecord::Schema.define(version: 2020_04_24_092833) do
  ...
  create_table "medical_stocks", force: :cascade do |t|
    t.text "medicine_name"
    t.integer "quantity"
    t.integer "medical_store_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["medical_store_id"], name: "index_medical_stocks_on_medical_store_id"
  end
  ...
  create_table "medical_stores", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.integer "user_id"
    t.index ["user_id"], name: "index_medical_stores_on_user_id"
  end

  create_table "medicine_stocks", force: :cascade do |t|
    t.text "name"
    t.integer "quantity"
    t.integer "medical_stores_id", null: false
    t.integer "price"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["medical_stores_id"], name: "index_medicine_stocks_on_medical_stores_id"
  end
  ...
  create_table "prescription_medicines", force: :cascade do |t|
    ...
    t.index ["prescriptions_id"], name: "index_prescription_medicines_on_prescriptions_id"
  end
  ...
  add_foreign_key "medical_stocks", "medical_stores"
  add_foreign_key "medicine_stocks", "medical_stores", column: "medical_stores_id"
